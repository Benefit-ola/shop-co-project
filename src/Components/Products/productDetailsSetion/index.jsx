...
import { circle, circle2, circle3, frame, frame10,  frame8, frame9, mg, mg2, mg3 } from "../../../constant";
  ...
  return (
    <div className="mx-[3rem] ">
      ...
      {activeTab === 2 && <div className="">
        ...
        <div>
          <h2 className="text-center font-bold text-4xl mt-5">YOU MIGHT ALSO LIKE </h2>
          <div className="grid grid-cols-4 gap-4 mt-10  text-center mb-10 ">
{products.map((data,i)=>(
  <div key={i} className=" ">
                <img src={data.image} alt={data.text} className="mb-4 transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer" />
